...
class ResCompany(models.Model):
    ...
    notify_create_user_after_second = fields.Boolean("Notify Create User Second")
...
class ResConfigSettings(models.TransientModel):
    ...
    notify_create_user_due = fields.Boolean(
        "Notify Create User Due", related='company_id.notify_create_user_due', readonly=False)
    ...
    notify_create_user_after_second = fields.Boolean(
        "Notify Create User Second", related='company_id.notify_create_user_after_second', readonly=False)
