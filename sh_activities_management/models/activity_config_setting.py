...
class ResCompany(models.Model):
    ...
    sh_display_all_activities_table = fields.Boolean('All Activities Table',default=True)
...
class ResConfigSettings(models.TransientModel):
    ...
    sh_display_all_activities_table = fields.Boolean('All Activities Counter Table',related='company_id.sh_display_all_activities_table',readonly=False)
