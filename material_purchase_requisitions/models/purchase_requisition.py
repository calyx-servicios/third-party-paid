        ...
        for rec in self:
            ...
            if any(
                ...
                picking_vals = {
                    ...
                    "location_dest_id": rec.dest_location_id
                    and rec.dest_location_id.id
                ...
                if line.requisition_type == "purchase":  # 10/12/2019
                    ...
                    for partner in line.partner_id:
                        if partner not in po_dict:
                            ...
                            # esto estaba comentado lo vuelvo a poner con "analytic_distribution": rec.analytic_account_id.id, cambiado
                            {
                                "product_id": line.product_id.id,
                                "name": line.product_id.name,
                                "product_qty": line.qty,
                                ...
                                "order_id": purchase_order.id,
                                "analytic_distribution": rec.analytic_account_id.id,
                            }
