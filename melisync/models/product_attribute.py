...
class ProductAttribute(models.Model):
    ...
    is_required = fields.Boolean(default=lambda self: bool(self.tag_ids.search([('name', 'in', ['required']), ('id', 'in', self.tag_ids.ids)])), store=False, readonly=True, string=_('Is required'))
